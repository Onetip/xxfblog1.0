...
<body>
    ...
    <section class="content-wrap">
        <div class="container">
            <div class="row">
                <main class="col-lg-10 col-lg-push-1 friend">
                    <h1>访客：qq登陆用户(100)</h1>
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><img src="<?php echo ($row['head']); ?>" alt="<?php echo ($row['nickname']); ?>" title="<?php echo ($row['nickname']); ?>" class="img-circle"><?php endforeach; endif; else: echo "" ;endif; ?>
                </main>
            </div>
        </div>
    </section>
