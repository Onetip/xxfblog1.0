...
<body>
    ...
    <div class="page-header clearfix">
        ...
        <ul class="nav nav-tabs">    
            ...
            <li class="active">
                <a href="<?php echo U('Twitter/update');?>">添加语录</a>
            </li>
        </ul>
    </div>

    <div class="content-box-content">
        <form action="<?php echo U('Twitter/update');?>" method="post" class="form-horizontal">
            <input type="hidden" name="model" value="Twitter">
            <input type="hidden" name="id" value="<?php echo ($row['id']); ?>">
            <div class="form-group">
                <label for="content" class="col-sm-2 control-label">语录内容：</label>
                <div class="col-sm-10">
                    <textarea class="form-control" name="content" id="content"><?php echo ($row['content']); ?></textarea>
                </div>
            </div>
            <div class="form-group">
