...
<body>
    ...
    <div class="page-header clearfix">
        ...
        <ul class="nav nav-tabs">
            ...
            <li>
                <a href="<?php echo U('ArticleCategory/add');?>">添加分类</a>
            </li>
        </ul>
    </div>
...
<!--提示 end-->
    ...
    <div class="content-box-content">
        ...
        <form action="<?php echo U('ArticleCategory/remove');?>" method="post" class="batch-form">
            <table class="table table-striped table-framed table-hover">
                ...
                <tbody class="tbody">
                <?php if(empty($cate_list)): ?><tr><td colspan="10"><span style="font-size:14px;">暂无数据</span></td></tr><?php endif; ?>
                <?php echo ($cate_list); ?>
                </tbody>
