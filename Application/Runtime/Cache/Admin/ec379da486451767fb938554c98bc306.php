...
<body>
    ...
    <div class="page-header clearfix">
        ...
        <ul class="nav nav-tabs">    
            <li>
                <a href="<?php echo U('Config/update');?>">网站设置</a>
            </li>
        </ul>
    </div>

    <div class="content-box-content">
        <form action="<?php echo U('Config/update');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="about" class="col-sm-2 control-label">关于：</label>
                <div class="col-sm-10">
                    <textarea  class="form-control" id="about" name="about" style="width:90%;height:400px;visibility:hidden;"><?php echo ($row['about']); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                <label for="icp" class="col-sm-2 control-label">ICP：</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="icp" name="icp" value="<?php echo ($row['icp']); ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="index_page" class="col-sm-2 control-label">前台分页数：</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="index_page" name="index_page" value="<?php echo ($row['index_page']); ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="admin_page" class="col-sm-2 control-label">后台分页数：</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="admin_page" name="admin_page" value="<?php echo ($row['admin_page']); ?>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <?php if(!empty($row['logo'])): ?><div class="col-md-2 thumbnail">
                        <img src="/myblog/Uploads<?php echo ($row['logo']); ?>">
                    </div><?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                <label for="tj" class="col-sm-2 control-label">统计代码：</label>
                <div class="col-sm-10">
                    <textarea class="form-control" id="tj" name="tj"><?php echo ($row['tj']); ?></textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="radio" name="status" value="9" <?php if(($row['status']) == "9"): ?>checked<?php endif; ?> >否
                </div>
            </div>
            <div class="form-group">
