...
<body>
    ...
    <div class="page-header clearfix">
        ...
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="<?php echo U('Twitter/index');?>">语录列表</a>
            </li>
            <li>
                <a href="<?php echo U('Twitter/add');?>">添加语录</a>
            </li>
        </ul>
    </div>
...
<!--提示 end-->
    <div class="content-box-content">
        <form action="<?php echo U('Twitter/remove');?>" method="post" class="batch-form">
            ...
            <table class="table table-striped table-framed table-hover">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" value="Twitter|status|<?php echo ($row['id']); ?>|1">
                            <span class="fa fa-eye-slash on-off fa-red" <?php if($row['status'] == 1): ?>style="display:none;"<?php endif; ?>></span>
                            <input type="hidden" value="Twitter|status|<?php echo ($row['id']); ?>|0">
                        </td>
                        <td>
                            <a href="#" title="删除" class="delete-delete">
                                <span class="fa fa-remove"></span>
                            </a><input type="hidden" value="<?php echo U('Twitter/remove',array('model'=>'Twitter','id'=>$row['id']));?>">
                        </td>
