...
<body>
    ...
    <div class="page-header clearfix">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="active">
                <a href="<?php echo U('Background/update');?>">编辑图片</a>
            </li>
        </ul>
    </div>

    <div class="content-box-content">
        <form action="<?php echo U('Background/update');?>" method="post" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="model" value="Background">
            <input type="hidden" name="id" value="<?php echo ($row['id']); ?>">
            <div class="form-group">
                <label for="img" class="col-sm-2 control-label">背景图片：</label>
                <div class="col-sm-10">
                    <input type="file" class="form-control" name="img" id="img">
                    <?php if(!empty($row['img'])): ?><div class="col-xs-6 col-md-4 thumbnail">
